...
public class ImportContacts
{
    ...
    @Expose
    private ArrayList<Contact> suggested_Contacts;
    ...
    public void insertContact(Contact contact)
    {
       /* if(contact.getPhotoUri()==null&&contact.getPhotoUri().isEmpty()) {
            this.suggested_Contacts.add(contact);
        }else{*/
    ...
    public ArrayList<Contact> getMobileContacts()
    {
        ...
        if (cursor != null)
        {
            ...
            suggested_Contacts = new ArrayList<>();
    ...
    public ArrayList<Contact> getSuggestedContacts()
    {
        boolean flag = hasPermission(Manifest.permission.READ_CONTACTS);
